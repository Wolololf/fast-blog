...
class DateutilDateParser(DateParserBase):
    ...
    def parse(self, date, **kwargs):
        ...
        # NOTE: If we use isoparse, we can remove all non-numerics as well as leading +/- signs and ?
        # after we've done the uncertainty parsing
        ...
        res = dateutil_parser._parse(date, **kwargs, fuzzy_with_tokens=True)
        ...
        # TODO: isoparse will only return one value!
        if res is None:
            # Couldn't parse it
            return None
